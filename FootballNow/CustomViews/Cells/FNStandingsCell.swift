...
class FNStandingsCell: UITableViewCell {
    ...
    func set(standing: Standing) {
        ...
        gamesPlayedLabel.text = "\(standing.all.played)"
        gamesWonLabel.text = "\(standing.all.win)"
        gamesDrawLabel.text = "\(standing.all.draw)"
        gamesLostLabel.text = "\(standing.all.lose)"
